...
from src.models.repositories.emails_to_invite_repository\
    import EmailsToEnviteRepository
...
def invite_to_trip(tripId):
    ...
    controller = ParticipantCreator(
        participants_repository, emails_to_invite_repository
        )
...
@trips_routes_bp.route(
        "/participants/<participantId>/confirm", methods=["PATCH"]
        )
